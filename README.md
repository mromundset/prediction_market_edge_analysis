...
| [`weather_mm_feasibility_exploration/`](weather_mm_feasibility_exploration/) | Can you profitably *provide* liquidity (market-make) on Kalshi's weather ladders instead of predicting them? (Strategy B4) | **Promising — first gross-positive edge found.** Passive side earns +3.5% of notional (+$2.1k/day NYC, Sharpe 0.53) at **zero maker fee**, with mild slow-moving adverse selection. Capturable share vs incumbent bots is the open question — needs a forward quote-simulation test — [RESULTS.md](weather_mm_feasibility_exploration/RESULTS.md) |
